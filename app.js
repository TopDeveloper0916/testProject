...
app.get('/client/add', passportConfig.isAuthenticated, clientController.addClient);
app.post('/client/add', passportConfig.isAuthenticated, clientController.postClient);
